...
err.rate = 1 - sum(bagging.pred == test$genotype)/length(test$genotype) #0.05116
pca.err.rate = 1 - sum(pca.bagging.pred == pca.test$genotype)/length(pca.test$genotype) #0.06047
